...
import { findTransactionObjects } from './findTransactionObjects'
import { getLatestInclusion } from './getLatestInclusion'
 ...
 *  @param {array} [bundle]
 */
export const getTransactionsFromBundle = (transactions: Transaction[], transaction: Transaction, bundle: Bundle = []): Bundle => {
...
export const addPersistence = (bundles: Bundle[]) => {
 ...
 */
export const getBundlesFromAddresses = (
    addresses: string[],
