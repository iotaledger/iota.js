...
* @param {Error|String} [error]     The error object/message.  Will be `null` if the request succeeded.
* @param {Object}       [result]    The result from the request.  Will be `null` if there was an error.
*
* Recommended usage:
* ```js
* api.doSomething(..., function(error, result) {
*   if( error ) {
*     // Handle error case.
*   } else {
*     // Handle success case.
