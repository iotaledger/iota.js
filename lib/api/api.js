...
* @param callback
*
    * @returns the output of the final sendTransfer call
*/
    /* ----------------------------------------------------------------------------*/
api.prototype.promoteTransaction = function(tail, depth, minWeightMagnitude, transfer, delay, maximum, callback) {
    ...
    self.sendTransfer(transfer[0].address, depth, minWeightMagnitude, transfers, {reference: tail}, function(err, res) {
        if (err == null && delay > 0 && maximum > 0) {
