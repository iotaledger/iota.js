...
Bundle.prototype.addEntry = function(signatureMessageLength, address, value, tag, timestamp, index) {
    ...
    var position = index ? index : this.bundle.length;
    ...
    for (var i = 0; i < signatureMessageLength; i++) {
        ...
        transactionObject.trunkTransaction = emptyHash;
        // Fill empty branchTransaction
        transactionObject.branchTransaction = emptyHash;
        // Fill empty nonce
        transactionObject.nonce = emptyHash;

        this.bundle[position] = transactionObject;
    }
}
