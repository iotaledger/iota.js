...
/**
*   Generates a new address or adds the key digest to generate a new multisig address
*
...
*   Does not contain signatures just yet
*
*   @method initiateTransfer
*   @param {object} inputAddress Currently only works with a single input
...
**/
var initiateTransfer = function(inputAddress, remainderAddress, numCosigners, transfers, callback) {
    ...
    if (totalValue) {
        ...
        api.getBalances(Array(inputAddress), 100, function(e, balance) {
...
**/
var addSignature = function(bundleToSign, cosignerIndex, inputAddress, key ) {
