...
/**
*   Generates the x-tryte checksum of any value
*
*   @method getChecksumOfValue
*   @param {string} value
*   @returns {integer} number of trytes (default 9)
**/
var getChecksumOfValue = function(value, nrTrytes) {
    ...
    // convert address into trits and map it into the state
    curl.state = Converter.trits(value, curl.state);

    curl.transform();

    var checksum = Converter.trytes(curl.state).substring(0, nrTrytes);
...
module.exports = {
    ...
    getChecksumOfValue  : getChecksumOfValue,
