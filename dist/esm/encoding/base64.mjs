...
export class Base64 {
  ...
  static decode(base64) {
    ...
    for (i = 0; i < len; i += 4) {
      tmp = Base64._REVERSE_LOOKUP[base64.charCodeAt(i)] << 18 | Base64._REVERSE_LOOKUP[base64.charCodeAt(i + 1)] << 12 | Base64._REVERSE_LOOKUP[base64.charCodeAt(i + 2)] << 6 | Base64._REVERSE_LOOKUP[base64.charCodeAt(i + 3)];
    ...
    if (placeHoldersLen === 1) {
      tmp = Base64._REVERSE_LOOKUP[base64.charCodeAt(i)] << 10 | Base64._REVERSE_LOOKUP[base64.charCodeAt(i + 1)] << 4 | Base64._REVERSE_LOOKUP[base64.charCodeAt(i + 2)] >> 2;
      arr[curByte++] = tmp >> 8 & 0xFF;
      arr[curByte++] = tmp & 0xFF;
    }
