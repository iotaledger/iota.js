...
export async function sendData(client, indexationKey, indexationData) {
  ...
  const indexationPayload = {
    ...
    data: indexationData ? typeof indexationData === "string" ? Converter.utf8ToHex(indexationData) : Converter.bytesToHex(indexationData) : undefined
  };
  const message = {
...
//# sourceMappingURL=sendData.mjs.map
