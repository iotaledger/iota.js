...
export class BigIntHelper {
  ...
  static read8(data, byteOffset) {
    const v0 = data[byteOffset + 0] + (data[byteOffset + 1] << 8) + (data[byteOffset + 2] << 16) + (data[byteOffset + 3] << 24) >>> 0;
    const v1 = data[byteOffset + 4] + (data[byteOffset + 5] << 8) + (data[byteOffset + 6] << 16) + (data[byteOffset + 7] << 24) >>> 0;
...
BigIntHelper.BIG_32 = BigInt(32); // @internal

BigIntHelper.BIG_32_MASK = BigInt(0xFFFFFFFF);
//# sourceMappingURL=bigIntHelper.mjs.map
