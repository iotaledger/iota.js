...
export class ReadStream {
  ...
  readUInt32(name, moveIndex = true) {
    ...
    const val = this._storage[this._readIndex] | this._storage[this._readIndex + 1] * 0x100 | this._storage[this._readIndex + 2] * 0x10000 + this._storage[this._readIndex + 3] * 0x1000000;
