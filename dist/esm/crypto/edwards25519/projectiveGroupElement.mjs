...
export class ProjectiveGroupElement {
  ...
  doubleScalarMultVartime(a, A, b) {
    ...
    const ai = [new CachedGroupElement(), new CachedGroupElement(), new CachedGroupElement(), new CachedGroupElement(), new CachedGroupElement(), new CachedGroupElement(), new CachedGroupElement(), new CachedGroupElement()]; // A,3A,5A,7A,9A,11A,13A,15A
...
//# sourceMappingURL=projectiveGroupElement.mjs.map
