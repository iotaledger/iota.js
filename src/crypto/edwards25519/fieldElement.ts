...
export class FieldElement {
     ...
     */
    public combine(h0: BigInteger, h1: BigInteger, h2: BigInteger, h3: BigInteger, h4: BigInteger,
        h5: BigInteger, h6: BigInteger, h7: BigInteger, h8: BigInteger, h9: BigInteger): void {
        let c0: BigInteger;
        let c4: BigInteger;
