...
export class Pbkdf2 {
    ...
    public static sha256(
        password: Uint8Array, salt: Uint8Array, iterations: number, keyLength: number): Uint8Array {
        return Pbkdf2.deriveKey(
            ...
            keyLength,
            32,
            (pass, block) => HmacSha256.sum256(pass, block)
        );
    }
    ...
    public static sha512(
        ...
        return Pbkdf2.deriveKey(
            ...
            keyLength,
            64,
            (pass, block) => HmacSha512.sum512(pass, block)
        );
    }
    ...
    private static deriveKey(
        ...
        keyLength: number,
        macLength: number,
        sumFunc: (pass: Uint8Array, block: Uint8Array) => Uint8Array): Uint8Array {
        if (iterations < 1) {
