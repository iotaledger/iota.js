...
describe("Binary Payload", () => {
    ...
    test("Can succeed with valid receipt data", () => {
        ...
        buffer.writeUInt16LE(1, 12); // Funds count
        buffer.write("a".repeat(98), 14, "hex"); // Tail transaction hash
        buffer.writeUInt8(1, 63); // Address type
        buffer.write("b".repeat(64), 64, "hex"); // Address
        buffer.writeBigUInt64LE(BigInt(100), 96); // Desposit
    ...
    test("Can serialize and deserialize receipt payload", () => {
        ...
        const hex = serialized.finalHex();
        // eslint-disable-next-line max-len
        expect(hex).toEqual("0300000040e201000100aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa01bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb6400000000000000");
    ...
    test("Can serialize and deserialize milestone payload with receipt", () => {
        ...
        const hex = serialized.finalHex();
        // eslint-disable-next-line max-len
        expect(hex).toEqual("");
        const deserialized = deserializeMilestonePayload(new ReadStream(Converter.hexToBytes(hex)));
        expect(deserialized.type).toEqual(1);
        expect(deserialized.index).toEqual(1087);
        expect(deserialized.timestamp).toEqual(1605190003);
