...
describe("Binary Unlock Block", () => {
    test("Can serialize and deserialize unlock blocks", () => {
        ...
        // eslint-disable-next-line max-len
        expect(hex).toEqual("020000006920b176f613ec7be59e68fc68f597eb3393af80f74c7c3db78198147d5f1f922c59d43952bda7ca60d3c2288ebc00703b4b60c928d277382cad5f57b02a90825f2d3a8509d6594498e0488f086d8fa3f13d9636d20e759eb5806ffe663bac0d01a05b");
    ...
    test("Can serialize and deserialize signature unlock block", () => {
        ...
        const hex = serialized.finalHex();
        // eslint-disable-next-line max-len
        expect(hex).toEqual("00006920b176f613ec7be59e68fc68f597eb3393af80f74c7c3db78198147d5f1f922c59d43952bda7ca60d3c2288ebc00703b4b60c928d277382cad5f57b02a90825f2d3a8509d6594498e0488f086d8fa3f13d9636d20e759eb5806ffe663bac0d");
