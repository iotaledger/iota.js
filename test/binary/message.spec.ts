...
describe("Binary Message", () => {
    ...
    test("Can succeed with valid data", () => {
        ...
        if (message.parentMessageIds) {
            expect(message.parentMessageIds[0])
                .toEqual("4594267ca0446739d5e4c6dcf060d640aafb68ab929aa2bb8c2bcdce8b3bc89e");
            expect(message.parentMessageIds[1])
                .toEqual("6901c7b37adbddfc3fc170773632489f263af4decc9ed5813c849a07319ecd73");
        }
    ...
    test("Can succeed with milestone data", () => {
        ...
        const hex = "";
    ...
    test("Can succeed with indexation data", () => {
        ...
        if (message.parentMessageIds) {
            expect(message.parentMessageIds[0])
                .toEqual("9eca185fb38d44471b0c396c6c147c3a2a4c590dc5dac6431b698c58dcce449a");
            expect(message.parentMessageIds[1])
                .toEqual("26b9c0077037bf198b35306408e4a9b50430bdf0ea54f722cc4e7ce4f7ffba5e");
        }
    ...
    test("Can succeed with actual milestone data", () => {
        // eslint-disable-next-line max-len
        const hex = "";
        const message = deserializeMessage(new ReadStream(Converter.hexToBytes(hex)));
    ...
    test("Can succeed with actual transaction data", () => {
        ...
        if (message.parentMessageIds) {
            expect(message.parentMessageIds[0])
                .toEqual("4ccb0843016072b0d0d1c4265bc808ef8a80ae4ad70e10d6016e248e4e047235");
            expect(message.parentMessageIds[1])
                .toEqual("aac2a777c07473522122629124d7df647b2ea712386707e3687dd3a47cbdfa55");
        }
