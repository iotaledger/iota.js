...
describe("Bech32Helper", () => {
    ...
    test("Can convert from bech32 format", () => {
        const address = Converter.hexToBytes("52fdfc072182654f163f5f0f9a621d729566c74d10037c4d7bbb0407d1e2c649");
        const result = Bech32Helper.fromBech32("iota1q9f0mlq8yxpx2nck8a0slxnzr4ef2ek8f5gqxlzd0wasgp73utryj0w6qwt");
    ...
    test("Can fail to match address invalid chars", () => {
        expect(Bech32Helper.matches("iotp1q9f0mlq8yxpx2nck8a0slxnzr4ef2ek8f5gqxlzd0wasgp73utryj0w6qwt")).toEqual(false);
    });

    test("Can match address", () => {
        expect(Bech32Helper.matches("iota1q9f0mlq8yxpx2nck8a0slxnzr4ef2ek8f5gqxlzd0wasgp73utryj0w6qwt")).toEqual(true);
    });
});
