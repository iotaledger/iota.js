...
describe("Bech32Helper", () => {
    test("Can convert to bech32 format", () => {
        ...
        expect(Bech32Helper.toBech32(1, address, "iota"))
    ...
    test("Can convert from bech32 format", () => {
        ...
        const result = Bech32Helper.fromBech32(
            "iota1q9f0mlq8yxpx2nck8a0slxnzr4ef2ek8f5gqxlzd0wasgp73utryj0w6qwt", "iota");
    ...
    test("Can fail to match address invalid chars", () => {
        expect(Bech32Helper.matches("iotp1q9f0mlq8yxpx2nck8a0slxnzr4ef2ek8f5gqxlzd0wasgp73utryj0w6qwt", "iota"))
            .toEqual(false);
    });

    test("Can match address", () => {
        expect(Bech32Helper.matches("iota1q9f0mlq8yxpx2nck8a0slxnzr4ef2ek8f5gqxlzd0wasgp73utryj0w6qwt", "iota"))
            .toEqual(true);
    });
});
