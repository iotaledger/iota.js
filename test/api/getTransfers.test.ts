...
import { AccountData, createGetTransfers } from '../../lib/api/extended'
import { Maybe } from '../../lib/api/types'
import { INVALID_SECURITY_LEVEL, INVALID_SEED, INVALID_START_END_OPTIONS, INVALID_START_OPTION } from '../../lib/errors'
...
const getTransfers = createGetTransfers(provider())
const seed = 'SEED'
