...
describe('api, when sending requests with a host that has a trailing slash after node has been changed', function() {
    var iota;
    var xhr;
    var requests;
    ...
    it('should remove the trailing slash from the host', function() {
        assert.equal(requests[0].url, 'http://new.iota.org:14265');
    });
});
