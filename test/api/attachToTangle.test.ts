...
import { createAttachToTangle } from '../../lib/api/core'
import { INVALID_BRANCH_TRANSACTION, INVALID_TRUNK_TRANSACTION, INVALID_TRYTES_ARRAY } from '../../lib/errors'
import { provider } from '../../lib/utils'
import { attachToTangleCommand, attachToTangleResponse } from '../nocks/attachToTangle'

const attachToTangle = createAttachToTangle(provider())
