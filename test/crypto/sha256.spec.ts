...
import testData from "./testData/sha256.json";

describe("Sha256", () => {
    test("Can perform a sha256 on short ascii", () => {
    ...
    test("Can perform a sha256 on empty ascii", () => {
        const sha = new Sha256();
    ...
    test("Can perform a sha256 on sentence", () => {
        ...
        const digest = sha.digest();
        expect(Converter.bytesToHex(digest))
            .toEqual("d7a8fbb307d7809469ca9abcb0082e4f8d5651e46d3cdb762d02d0bf37c9e592");
    });
