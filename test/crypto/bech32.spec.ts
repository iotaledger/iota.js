...
describe("Bech32", () => {
    ...
    test("Can encode a string", () => {
        ...
        expect(Bech32.encode("iota", address))
            .toEqual("iota1q9f0mlq8yxpx2nck8a0slxnzr4ef2ek8f5gqxlzd0wasgp73utryj0w6qwt");
    });
    ...
    test("Can fail to match address hrp mismatch", () => {
        expect(
            Bech32.matches("iota", "iop1q9f0mlq8yxpx2nck8a0slxnzr4ef2ek8f5gqxlzd0wasgp73utryjtzcp98")).toEqual(false);
    });

    test("Can fail to match address seprator missing", () => {
        expect(
            Bech32.matches("iota", "iopq9f0mlq8yxpx2nck8a0slxnzr4ef2ek8f5gqxlzd0wasgp73utryjtzcp98")).toEqual(false);
    });

    test("Can fail to match address invalid chars", () => {
        expect(
            Bech32.matches("iota", "iota1q9f0mlqZyxpx2nck8a0slxnzr4ef2ek8f5gqxlzd0wasgp73utryjtzcp98")).toEqual(false);
    });

    test("Can match address", () => {
        expect(
            Bech32.matches("iota", "iota1q9f0mlq8yxpx2nck8a0slxnzr4ef2ek8f5gqxlzd0wasgp73utryjtzcp98")).toEqual(true);
    });
});
