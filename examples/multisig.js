...
// First party generates this, then passes initiatedMultisigAddress to the second party
var digestOne = iota.multisig.getDigest('ABCDFG', 0);
var initiatedMultisigAddress = iota.multisig.addAddressDigest(digestOne);

// Second party generates this. The address is passed back to the first party.
...
iota.multisig.initiateTransfer(
    address, 'ABCFYSUQFVBFGNHOJMLWBHMGASFGBPAUMRZRRCJFCCOJHJKZVUOCEYSCLXAGDABCEWSUXCILJCGQWI9SF', 
    2, [{'address': 'GWXMZADCDEWEAVRKTAIWOGE9RDX9QPKJHPPQ9IDDOINY9TUWJGKCWF9GSOW9QBPNRVSVFLBMLPAHWDNSB', 'value': 15}], 

    function(e, unsignedBundle) {
        var firstKey = iota.multisig.getKey('ABCDFG', 0);
        iota.multisig.addSignature(
            unsignedBundle, 0, 'JUIFYSUQFVBFGNHOJMLWBHMGASFGBPAUMRZRRCJFCCOJHJKZVUOCEYSCLXAGDABCEWSUXCILJCGQWI9SF', 
            firstKey, function(e, bundleWithOneSig) {

                var secondKey = iota.multisig.getKey('FDSAG', 0);
                iota.multisig.addSignature(
                    bundleWithOneSig, 1, 
                    'JUIFYSUQFVBFGNHOJMLWBHMGASFGBPAUMRZRRCJFCCOJHJKZVUOCEYSCLXAGDABCEWSUXCILJCGQWI9SF', secondKey, 
