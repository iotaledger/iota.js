# IOTA Typescript Library

## Warning!
> **This is an early version of iota.lib.js port to TypeScript. DO NOT use in production yet.**

> **This README has also not been updated yet (working on it!) so the
> installation instructions and API are not yet documented, please refer to the
> code for details.**
