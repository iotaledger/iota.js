...
describe("Binary Foundry Output", () => {
    test("Can serialize and deserialize foundry output", () => {
        ...
        expect(hex).toEqual(
            ""
        );
        ...
        expect(deserialized.mintedTokens).toEqual("0x100000");
        expect(deserialized.meltedTokens).toEqual("0x1000");
        expect(deserialized.maximumSupply).toEqual("0x200000");
