...
describe("Binary Nft Output", () => {
    test("Can serialize and deserialize nft output", () => {
        const object: INftOutput = {
            ...
            nftId: "0x1111111111111111111111111111111111111111223344556677889900112233",
            unlockConditions: [],
            featureBlocks: [],
        ...
        expect(hex).toEqual(
            ""
        );
        ...
        expect(deserialized.nftId).toEqual("0x1111111111111111111111111111111111111111223344556677889900112233");
    });
});
