...
describe("Binary Payload", () => {
    ...
    test("Can succeed with valid receipt data", () => {
        ...
        buffer.write("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", 15, "hex"); // Tail transaction hash
        buffer.writeUInt8(0, 64); // Address type
        buffer.write("bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb", 65, "hex"); // Address
        ...
        buffer.write("cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc", 114, "hex"); // Milestone hash
