...
describe("Binary Block", () => {
    ...
    test("Can succeed with valid data", () => {
        ...
        expect(block.parentBlockIds).toBeDefined();
        if (block.parentBlockIds) {
            expect(block.parentBlockIds[0]).toEqual(
                "0x4594267ca0446739d5e4c6dcf060d640aafb68ab929aa2bb8c2bcdce8b3bc89e"
            );
            expect(block.parentBlockIds[1]).toEqual(
    ...
    test("Can succeed with milestone data", () => {
        ...
        if (block.parentBlockIds) {
            ...
            expect(block.parentBlockIds[2]).toEqual(
        ...
        expect(payload.parentBlockIds[0]).toEqual("0x0d34993b5485a59c9c54f04068ea2caf9f2f76c58228013f1ad03dd6dfc06829");
        expect(payload.parentBlockIds[1]).toEqual("0xce68b9feaa6f6df5eed44781a8c6881cd1d8910da905625dc20ca9986e85887b");
        expect(payload.parentBlockIds[2]).toEqual("0xd539f3c16201bd6935a8daaa2e6efc775a5722ca31287e7e7e92842db111454d");
