...
| `blockPartial.protocolVersion?` | `number` | - |
| `blockPartial.parents?` | `string`[] | - |
| `blockPartial.payload?` | [`IMilestonePayload`](IMilestonePayload.md) \| [`ITaggedDataPayload`](ITaggedDataPayload.md) \| [`ITransactionPayload`](ITransactionPayload.md) | - |
| `blockPartial.nonce?` | `string` | - |
