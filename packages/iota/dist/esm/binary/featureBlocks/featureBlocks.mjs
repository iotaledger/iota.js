...
import { UINT16_SIZE } from "../commonDataTypes.mjs";
...
import { deserializeReturnFeatureBlock, MIN_RETURN_FEATURE_BLOCK_LENGTH, serializeReturnFeatureBlock } from "./returnFeatureBlock.mjs";
