...
export async function sendData(
    ...
    indexationData?: Uint8Array | string
): Promise<{
    message: IMessage;
    messageId: string;
}> {
    ...
    const localIndexationKeyHex =
        typeof indexationKey === "string" ? Converter.utf8ToHex(indexationKey) : Converter.bytesToHex(indexationKey);
