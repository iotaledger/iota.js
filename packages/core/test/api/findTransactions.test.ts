...
import { INVALID_HASH_ARRAY, INVALID_TAG } from '../../src/errors'
import {
...
const findTransactions = createFindTransactions(httpClient())

const invalidHashes = [
    'sdfsdSADASDG'
]

const addressesWithChecksum = [...(findTransactionsByAddressesCommand.addresses as string[])]
    .map(address => address.concat('9'.repeat(9)))
