...
const wereAddressesSpentFrom = createWereAddressesSpentFrom(httpClient())

const addressesWithChecksum = wereAddressesSpentFromCommand.addresses.map(address => address.concat('9'.repeat(9)))
