import { IMessage, IMessageMetadata, IOutputResponse } from "@iota/iota.js";
...
export declare class MqttClient implements IMqttClient {
     ...
     */
    constructor(endpoints: string | string[], keepAliveTimeoutSeconds?: number);
    /**
     ...
     * @returns A subscription Id which can be used to unsubscribe.
     */
    transactionIncludedMessage(transactionId: string, callback: (topic: string, data: IMessage, raw: Uint8Array) => void): string;
    /**
