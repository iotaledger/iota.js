...
You can also generate a seed from a mnemonic by using the [Ed25519Seed.fromMnemonic(mnemonic)](../references/client/classes/Ed25519Seed#frommnemonic)
function.

##### Generate a Random Mnemonic

You can generate a random mnemonic using the [Bip39.randomMnemonic(length?)](../references/crypto/classes/Bip39#randommnemonic) function.
...
You can generate a new Bip44 address using the [generateBip44Address(generatorState	)](../references/client/api_ref#generatebip44address) function. You will need to provide an [IBip44GeneratorState](../references/client/interfaces/IBip44GeneratorState) as `generatorState`.
...
You can retrieve an address by using the [Ed25519Address.toAddress()](../references/client/classes/Ed25519Address#toaddress)
function.
