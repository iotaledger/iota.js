---
description: "Learn how to send and retrieve data using the iota.js client library."
...
Before you can send data, you will need to:
...
* [Converter.utf8ToBytes(utf8)](../references/util/classes/Converter.md#utf8tobytes).
* [Converter.utf8ToBytes(binary)](../references/util/classes/Converter.md#binarytobytes).
* [Converter.base64ToBytes(base64)](../references/util/classes/Converter.md#base64tobytes).

## Send Data

You can use the [sendData(client, tag?, data?)](../references/client/api_ref.md#senddata) function to send data to a
...
You can use the [retrieveData(client, blockId)](../references/client/api_ref.md#retrievedata) function to retrieve data
