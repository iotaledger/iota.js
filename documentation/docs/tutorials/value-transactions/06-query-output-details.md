...
If you know an `output Id` you can query the details of using the Node API and therefore through the `iota.js` library.
...
* The **output details** including the type of output (`3` for value, i.e. basic outputs), the amount (in Glows) and the
