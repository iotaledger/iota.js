    ...
    plugins: [
        ...
        [
            '@iota-wiki/plugin-tutorial',
            {
                ...
                route: '/shimmer/iotajs/tutorials/alias-transactions/introduction',
                tags: ['text', 'getting-started', 'client', 'shimmer', 'js'],
            },
        ],
        [
            '@iota-wiki/plugin-tutorial',
            {
                ...
                route: '/shimmer/iotajs/tutorials/native-token-transactions/introduction',
                tags: ['text', 'getting-started', 'client', 'shimmer', 'js'],
            },
        ],
        [
            '@iota-wiki/plugin-tutorial',
            {
                ...
                route: '/shimmer/iotajs/tutorials/nfts/introduction',
                tags: ['text', 'getting-started', 'client', 'shimmer', 'js'],
            },
        ],
    ],
